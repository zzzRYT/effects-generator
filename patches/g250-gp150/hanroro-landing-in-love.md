...
```
guitar: {"selector":5,"volume":10,"note":"따뜻한 클린 — 더 또렷한 커팅은 미들+넥(pos 4)"}
...
```
guitar: {"selector":5,"volume":10,"note":"코러스가 폭을 넓혀줌"}
...
```
guitar: {"selector":5,"volume":10,"note":"아르페지오 넥 싱글(pos 5) / 스트럼·커팅 미들+넥(pos 4)"}
