...
```
guitar: {"selector":4,"volume":10,"note":"글래시 커팅 — 벌스 받침은 넥 싱글(pos 5)"}
...
```
guitar: {"selector":3,"volume":10,"note":"글래시 클린 — 더 따뜻하게는 넥 싱글(pos 5)"}
...
```
guitar: {"selector":4,"volume":10,"note":"글래시 쿼킹 — 또는 미들(pos 3)"}
